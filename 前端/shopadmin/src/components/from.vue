<template>
  <div style="position: relative; width: 100%; height: 100%">
    ...
    >
      ...
      <el-table-column width="100" prop="fromid" label="订单号" />
      <el-table-column width="100" prop="status" label="订单状态" />
      <el-table-column width="100" prop="price" label="支付价格" />
      <el-table-column width="100" prop="shopid" label="商品ID" />
      <el-table-column width="100" prop="userid" label="用户ID" />
      <el-table-column width="100" prop="time" label="日期" />
      <el-table-column width="325" prop="address" label="收货地址" />
